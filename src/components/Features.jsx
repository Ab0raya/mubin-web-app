    ...
    <section id="features" className="py-section-gap px-4 md:px-margin-desktop max-w-container-max mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-stack-lg">
        ...
        {features.map((feat, index) => (
          <div
            key={index}
            className="glass-card p-stack-lg rounded-2xl group hover:border-primary/30 transition-all duration-500 hover:-translate-y-2"
          >
        ...
        <div className="glass-card p-stack-lg rounded-2xl group hover:border-primary/30 transition-all duration-500 hover:-translate-y-2 md:col-span-2 overflow-hidden relative">
          ...
          {/* Decorative Backing Star Icon */}
          <div className="absolute -bottom-10 -left-10 opacity-10 text-primary transform translate-x-5 translate-y-5 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:scale-110 transition-transform duration-700">
            <span className="material-symbols-outlined text-[160px] md:text-[200px]" style={{ fontVariationSettings: "'FILL' 1" }}>
              star
            </span>
          </div>
        </div>
